...
<img src="/2d-docs/diagrams/cross-chain-check.svg?v=4" alt="Cross-chain check ordering inside the verifier" style="width:100%;max-width:720px;display:block;margin:1.5rem auto;aspect-ratio:640/160" />
