...
<img src="/2d-docs/diagrams/cross-chain-check.svg?v=2" alt="Cross-chain check ordering inside the verifier" style="width:100%;max-width:720px;display:block;margin:1.5rem auto;aspect-ratio:720/200" />
...
<img src="/2d-docs/diagrams/bridge-in-flow.svg?v=2" alt="Bridge-in token flow animation" style="width:100%;max-width:720px;display:block;margin:1.5rem auto;aspect-ratio:720/240" />
