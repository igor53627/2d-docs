...
<object type="image/svg+xml" data="/2d-docs/diagrams/cross-chain-check.svg" style="width:100%;max-width:720px;display:block;margin:1.5rem auto;aspect-ratio:720/220" aria-label="Cross-chain check ordering inside the verifier">Cross-chain check ordering diagram</object>
