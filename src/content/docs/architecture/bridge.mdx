...
Production deploys [`OperatorVault.sol`](https://github.com/igor53627/2d-solidity/blob/cb79c71ed5ec6b4d20e8a95fcbb3aaee0afa9a23/src/OperatorVault.sol) as the Ethereum-side operator wallet. The vault is a UUPS-upgradeable smart contract that splits the operator into two roles enforced on-chain.
