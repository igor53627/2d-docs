...
Пора от абстракций к коду. Ниже целевой дизайн HTLC precompile, первого precompile с реальным состоянием в нашей дорожной карте. Код ещё не написан, только форма; этого хватит, чтобы увидеть, как precompile выглядит в жизни.
