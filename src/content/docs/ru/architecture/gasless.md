...
Каждая транзакция на 2D бесплатна. Нет gas price, нет fee market, нет EIP-1559 base fee. Поле `effectiveGasPrice` в receipt всегда ноль (и `gasPrice` в объекте транзакции — тоже ноль). Кошельки показывают нулевую комиссию.
