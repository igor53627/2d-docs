...
<object type="image/svg+xml" data="/2d-docs/diagrams/cross-chain-check.svg?v=2" style="width:100%;max-width:720px;display:block;margin:1.5rem auto;aspect-ratio:720/200" aria-label="Cross-chain check ordering inside the verifier">Cross-chain check ordering diagram</object>
...
<object type="image/svg+xml" data="/2d-docs/diagrams/bridge-in-flow.svg?v=2" style="width:100%;max-width:720px;display:block;margin:1.5rem auto;aspect-ratio:720/240" aria-label="Bridge-in token flow animation">Bridge-in flow diagram</object>
