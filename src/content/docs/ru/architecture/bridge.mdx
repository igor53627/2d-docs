...
<object type="image/svg+xml" data="/2d-docs/diagrams/bridge-in-flow.svg" style="width:100%;max-width:720px;display:block;margin:1.5rem auto;aspect-ratio:720/240" aria-label="Bridge-in token flow animation">Bridge-in flow diagram</object>
