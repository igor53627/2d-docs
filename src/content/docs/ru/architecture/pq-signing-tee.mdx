...
Впереди: промышленный формат запечатывания (seal), обновление вершины цепи между arm и sign, использование целочисленных ключей CBOR, Elixir-прослойка (shim) и полноценный транспорт vsock.
