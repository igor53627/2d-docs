...
В [`impl/rust/enclave-protocol`](https://github.com/igor53627/2d-hsm/tree/main/impl/rust/enclave-protocol): framing, `ticketHash`, cross-check с Solidity, `EnclaveState`, Producer Chain Attestation v1, ML-DSA-65 с **production seal v1** (ChaCha20Poly1305 AEAD, measurement-bound, SNP-derived root через `snp-derive-root`).
