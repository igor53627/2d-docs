...
5. После завершения синхронизации верификатор обрабатывает live-блоки по мере их поступления. Блоки, которые уже были зафиксированы на этапе catch-up, пропускаются.
...
| **timestamp** | Блок, помеченный временем раньше своего родителя. Timestamp-метки монотонны: производитель подтягивает их вперёд при обратном скачке часов, поэтому регрессия timestamp означает расходящийся или скомпрометированный upstream. |
